...
public final class StructuresConfigManager {
	...
	private static JsonArray defaultMadokuPetEntries() {
		return StructuresConfigManager.entries(
			...
			StructuresConfigManager.item("minecraft:cow_spawn_egg", 40, 1, 1),
			StructuresConfigManager.item("minecraft:skeleton_spawn_egg", 80, 1, 1),
			StructuresConfigManager.item("minecraft:spider_spawn_egg", 80, 1, 1),
			StructuresConfigManager.item("minecraft:creeper_spawn_egg", 80, 1, 1),
			StructuresConfigManager.item("minecraft:bat_spawn_egg", 60, 1, 1),
			StructuresConfigManager.item("minecraft:bee_spawn_egg", 60, 1, 1),
			StructuresConfigManager.item("minecraft:chicken_spawn_egg", 40, 1, 1)
		);
	}
